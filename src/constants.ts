...
export const COM_OPEN_FILE = 'file-git-history.openFile'
export const COM_RELOAD = 'file-git-history.reload'
export const COM_SHOW_TIME = 'file-git-history.showTitleTime'
export const COM_HIDE_TIME = 'file-git-history.hideTitleTime'
